class products:
    ...
    def print_all_products():
        ...
        for pid in products.inventory:
            print("Product = {i}")
            i += 1
            print(f"Product ID : {products.inventory[pid]['Product ID']}")
            print(f"Product Name : {products.inventory[pid]['name']}")
            print(f"Product Price : {products.inventory[pid]['price']}")
            print(f"Product Quantity : {products.inventory[pid]['quantity']}")
...
P1 = products("P1", "Laptop", 50000, 5)
P2 = products("P2", "Mobile", 20000, 5)
P3 = products("P3", "Ipad", 45000, 6)
