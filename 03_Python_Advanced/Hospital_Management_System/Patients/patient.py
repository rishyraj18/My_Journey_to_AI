...
class patients():
        ...
        def __init__(self, patient_ID, patient_name, patient_age,Admitted_date, patient_ph, patient_gender, patient_address,treatments):
...
with open(file, "r", encoding="utf-8") as f:
    ...
    for key in keys:
          patients_obj[key] = patients(key,patients_dic[key]["Name"],patients_dic[key]["Age"], patients_dic[key]["Admitted Date"],patients_dic[key]["Phone Number"],patients_dic[key]["Gender"],patients_dic[key]["Address"],patients_dic[key]["Treatments"] )
...
def addpatient():
        ...
        patients_obj[patient_id] = patients(patient_id, patient_name, patient_age,Admitted_date, patient_ph, patient_gender, patient_address)
